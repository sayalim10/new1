...
public class Cust_DeliveryScreen extends SuperMessActivity {
...
//    }
    ...
    protected View onDevNCreate(Bundle savedInstanceState) {
        ...
        Cust_DeliveryAdapter adapter = new Cust_DeliveryAdapter(getSupportFragmentManager());
    ...
    public void dist(){
        Intent intent = new Intent(this,  ReturnDcLunchScreen.class);
