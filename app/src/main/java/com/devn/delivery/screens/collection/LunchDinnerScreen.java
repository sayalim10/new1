...
public class LunchDinnerScreen extends SuperMessActivity {
...
//    }
    ...
    protected View onDevNCreate(Bundle savedInstanceState) {
        ...
        LunchDinnerAdapter adapter = new LunchDinnerAdapter(getSupportFragmentManager());
    ...
    public void dist(){
        Intent intent = new Intent(this,  DistributionCollectScreen.class);
