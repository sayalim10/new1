...
public class DistributionCollectScreen extends SuperMessActivity {
...
//    }
    ...
    protected View onDevNCreate(Bundle savedInstanceState) {
        ...
        DistributionCollectAdapter adapter = new DistributionCollectAdapter(getSupportFragmentManager());
    ...
    public void dist(){
        Intent intent = new Intent(this,  Cust_DeliveryScreen.class);
